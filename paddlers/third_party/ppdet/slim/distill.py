...
from paddlers.third_party.ppdet.core.workspace import register, create, load_config
from paddlers.third_party.ppdet.modeling import ops
from paddlers.third_party.ppdet.utils.checkpoint import load_pretrain_weight
