...
def load_model(model_dir, **params):
    ...
    if not hasattr(paddlers.models, model_info['Model']):
        raise Exception("There's no attribute {} in paddlers.models".format(
            model_info['Model']))
    ...
    with paddle.utils.unique_name.guard():
        model = getattr(paddlers.models, model_info['Model'])(
