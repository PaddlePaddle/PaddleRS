...
class BaseChangeDetector(BaseModel):
    ...
    def predict(self, img_file, transforms=None):
        ...
        Args:
            ...
            decoded image data for bi-temporal images, which also could constitute a 
            list, meaning all image pairs to be predicted as a mini-batch.
    ...
    def slider_predict(self,
        ...
        Args:
            ...
            transforms(paddlers.transforms.Compose or None, optional):
                Transforms for inputs. If None, the transforms for evaluation process 
