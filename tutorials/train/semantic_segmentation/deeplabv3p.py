...
# Image segmentation model deeplabv3 training example script
...
# Build DeepLab V3+ model, using ResNet-50 as backbone
# Currently supported models: https://github.com/PaddlePaddle/PaddleRS/blob/develop/docs/intro/model_zoo.md
# Model input parameters refer to：https://github.com/PaddlePaddle/PaddleRS/blob/develop/paddlers/tasks/segmenter.py
