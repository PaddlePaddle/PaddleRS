...
# Image segmentation model Unet training example script
...
# Define data transformations to be used in training and validation (data augmentation, preprocessing, etc.)
