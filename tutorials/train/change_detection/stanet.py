...
# Change detection model stanet training example script
...
# using a combination of Compose multiple transformation methods. Transformations contained in Compose will be executed sequentially
...
# Build STANet model with default parameters
# Currently supported models can be found at https://github.com/PaddlePaddle/PaddleRS/blob/develop/docs/intro/model_zoo.md
