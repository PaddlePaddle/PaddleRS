...
# Change detection model FC_siam_conc training example script
...
eval_transforms = T.Compose([
    ...
    T.Normalize(
        mean=[0.5, 0.5, 0.5], std=[0.5, 0.5, 0.5]),
    # The normalization of the mean and standard deviation is specified
    T.ReloadMask(),
...
# ——https://github.com/PaddlePaddle/PaddleRS/blob/develop/docs/intro/model_zoo.md
