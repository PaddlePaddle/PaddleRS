...
# Example script for training object detection model Faster R-CNN
...
# Currently supported models are available at https://github.com/PaddlePaddle/PaddleRS/blob/develop/docs/intro/model_zoo.md
