...
if __name__ == '__main__':
    run_script(
        f"python coco_tools/json_info_show.py --json_path ../tests/data/instances_train2017.json",
        wd="../tools")
    run_script(
    ...
    run_script(
        ...
        wd="../tools")
    run_script(
        f"python coco_tools/image_sta.py --json_path ../tests/data/instances_train2017.json -csv_path ../tests/data/instances_val2017_images.csv --pic_shape_path ../tests/data/images_shape.png --pic_shape_rate_path ../tests/data/shape_rate.png",
        wd="../tools")
    run_script(
        f"python coco_tools/anno_sta.py --json_path ../tests/data/instances_train2017.json -csv_path ../tests/data/instances_val2017_annos.csv --pic_shape_path ../tests/data/images_shape.png --pic_shape_rate_path ../tests/data/shape_rate.png --pic_pos_path ../tests/data/pos.png --pic_pos_end_path ../tests/data/pos_end.png --pic_cat_path ../tests/data/cat.png --pic_obj_num_path ../tests/data/obj_num.png",
        wd="../tools")
